                            ...
                            @forelse ($users as $data)
                                <tr class="odd:bg-white odd:dark:bg-gray-800 even:bg-gray-50 even:dark:bg-gray-700">
                                    ...
                                    <div class="flex space-x-3">
                                        ...
                                        {{-- Edit button --}}
                                        <a href="{{ route('user.edit', $data) }}" class="text-yellow-600 dark:text-yellow-400 whitespace-nowrap">
                                            Edit
                                        </a>
...
@if (request('search'))
                    <h2 class="pb-3 text-xl font-semibold leading-tigtht text-gray-800 dark:text-gray-200">
