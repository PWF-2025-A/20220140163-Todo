        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-between items-center">
                    <span class="text-lg font-semibold">Daftar Kategori</span>
                    <a href="{{ route('categories.create') }}" class="text-xs text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg px-3 py-2">
                        + Tambah Kategori
                    </a>
                </div>
            </div>
                                ...
                                <tr class="odd:bg-white even:bg-gray-50 border-b dark:border-gray-700 odd:dark:bg-gray-900 even:dark:bg-gray-800">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-3">
                                            <a href="{{ route('categories.edit', $category) }}" class="text-indigo-600 dark:text-indigo-400 hover:underline text-xs">Edit</a>
