                    ...
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="block w-full mt-1 rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:border-indigo-500 dark:focus:ring-indigo-500"></textarea>
